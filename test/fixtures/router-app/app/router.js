module.exports = function (app) {
  ...
  app
    ...
    .post('/services/:id/before', app.controller.services.customize)
    .resources('/services', app.controller.services)
    .post('/services/:id/after', app.controller.services.customize)
